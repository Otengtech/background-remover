...
const Pricing = () => {
  ...
  const p4Ref = useScrollRevealMap(3);
  const p5Ref = useScrollReveal();
  const p6Ref = useScrollReveal();
  const p7Ref = useScrollRevealMap(6);
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        { included: false, text: "Premuim Ai processing" },
      ],
      limits: {
        resolution: "1080p (HD)",
        imagesPerMonth: 100,
  ...
  const faqs = [
    {
      ...
      answer:
        "Free users get 10 high-quality background removals per month at 720p resolution. Perfect for occasional use.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "We accept all major payment methods in Ghana including Mobile Money (MTN, Vodafone), Visa, MasterCard, and bank transfers.",
    },
    {
      question: "Do you store my images?",
      answer:
        "No, we process images in real-time and delete them immediately after processing. Your privacy is our priority.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Free/Basic users can purchase additional image packs. Pro users have unlimited access.",
    },
  ];
      ...
      <section className="pt-24 pb-16 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <div ref={p1Ref} className="scroll-reveal from-bottom md:from-right inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-500/10 border border-primary-500/20 mb-6">
            ...
            <h1 ref={p2Ref} className="scroll-reveal from-bottom text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Plans for <span className=" text-[#7c3aed]">Every Creator</span>
            </h1>

            <p ref={p3Ref}className="scroll-reveal from-bottom text-gray-400 text-xl max-w-2xl mx-auto mb-10">
              Start removing backgrounds for free. Upgrade anytime for higher
              resolution and more features.
            </p>
            ...
            {!isAuthenticated && (
              <div className="inline-flex items-center bg-dark-card rounded-full p-1 mb-12">
                ...
                >
                  Yearly{" "}
                  <span className="text-green-400 text-sm ml-2">Save 17%</span>
                </button>
              </div>
            )}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            {plans.map((plan, index) => (
              <div
                key={index}
                ref={p4Ref(index)}
                className={`scroll-reveal from-bottom card relative transform transition-all duration-500 hover:scale-[1.02] ${
                  plan.popular
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <Link
                    ...
                    onClick={(e) =>
                      isCurrentPlan(plan.planType) && e.preventDefault()
                    }
                  >
                    {plan.cta}{" "}
                    {!isCurrentPlan(plan.planType) && <FiArrowRight />}
                  </Link>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-medium">
                        {plan.limits.resolution}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Images/Month:</span>
                      <span className="text-white font-medium">
                        {plan.limits.imagesPerMonth}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Speed:</span>
                      <span className="text-white font-medium">
                        {plan.limits.processingSpeed}
                      </span>
                    </div>
                  </div>
                </div>
          ...
          {/* FAQ Section */}
          <div className="mb-20">
            <div ref={p5Ref} className="scroll-reveal from-bottom text-center mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {faqs.map((faq, index) => (
                <div
                  key={index}
                  ref={p7Ref(index)}
                  className="scroll-reveal from-bottom card hover:border-gray-700 transition-all duration-300"
                >
            ...
            <div className="text-center mb-20">
              <div className="glass-effect rounded-2xl p-12 max-w-3xl mx-auto">
                ...
                <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
                  Join thousands of creators who trust RemoveIt for their
                  background removal needs. No credit card required to start
                  with our free plan.
                </p>
          ...
          {/* Payment Methods */}
          <div ref={p6Ref} className="scroll-reveal from-bottom bg-dark-card/50 py-8 rounded-2xl">
            <div className="container mx-auto max-w-6xl px-6">
              ...
              <p className="text-gray-600 text-center text-xs mt-6 max-w-2xl mx-auto">
                All payments are processed securely via Paystack. We never store
                your payment details. Payments are in Ghanaian Cedis (GHS).
              </p>
            </div>
          </div>
        </div>
